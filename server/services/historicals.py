...
class Historicals:
    def __init__(self, eod_data_service: EODData, config: Config, db_connection=None):
        self.config = config
    ...
    def build_summary(self):
        ...
        for instrument in self.params["instruments"]:
            for timeframe in self.params["timeframes"]:
                ...
                summary.add_columns_ensure_correct_types()
    ...
    async def run_historicals(self):
        try:
            start_time = time.time()
            self.logger.logger.info("Starting - Historicals")
            ...
            self.logger.logger.info("Finished - Historicals")
            end_time = time.time()
            ...
            self.logger.logger.error(f"Error in historicals: {str(e)}")
            raise
